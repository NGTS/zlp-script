...
def main():
  ...
  # mycatname -   imcore catalogue, output from dist_solve.sh as MYCATNAME
  # chain_name -  mcmc chain output (chain name in main script)
  # catsrc -      wcsfit cached 2mass source catalogue
  # dummy_name -  file to update the headers with the best WCS solution
